        ...
        <div className={`space-y-8 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}>
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p className="text-pretty">
              Passionate Software Engineer with 5+ years of experience in developing web applications and backend
            ...
            <p className="text-pretty">
              I specialize in building scalable microservices architectures, responsive frontend applications, and
              implementing modern DevOps practices. My approach combines technical excellence with effective
              communication and a strong focus on code quality.
            </p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Wrexham University, UK</p>
                </div>
                <div>
                  <p className="font-medium">Higher Diploma in IT</p>
                  <p className="text-sm text-muted-foreground">SLIATE, Sri Lanka</p>
                </div>
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Basic & Advanced (2024)</p>
                </div>
                <div>
